...
class Googlemap {
	...
	var $apiKey						= 'AIzaSyDhVJ8vqPXA5sNXH1P2JYJfBnajhy78N-M'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
