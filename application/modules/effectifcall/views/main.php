<a href="<?php echo base_url('effectifcall/tambah'); ?>" type="button" class="btn btn-success" ><i class="fa fa-user"></i> Tambah</a>

<div class="x_panel">
  <div class="x_title">
    <h2><i class="fa fa-group"></i> List Effectif Call</h2>
