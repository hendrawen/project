              ...
              <div class="x_title">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo base_url('admin/karyawan/create'); ?>" type="button" class="btn btn-primary" > <i class="fa fa-plus"></i> Tambah Karyawan</a>
                        </div>
                  </div>
                    <div class="col-md-6 text-right">
                              ...
                              <tbody>
                               ...
                               <tr>
                                    ...
                                    <td style="text-align:center">
                                      <a href="<?=base_url()?>admin/karyawan/read/<?=$key->id_karyawan ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-search"></i></a>
                                      <a href="<?=base_url()?>admin/karyawan/update/<?=$key->id_karyawan ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                                      ...
                                      <a class="btn btn-default btn-sm" onclick="return swal({
                                                              ...
                                                              confirmButtonColor: '#d9534f',
                                                                    ...
                                                                    window.location.href ='<?=base_url()?>admin/karyawan/delete/<?=$key->id_karyawan ?>';
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <a></a>
                          		<?php echo anchor(site_url('admin/karyawan/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                          		<?php echo anchor(site_url('admin/karyawan/word'), 'Word', 'class="btn btn-primary"'); ?>
                  	    </div>
                      </div>
                    </div>
