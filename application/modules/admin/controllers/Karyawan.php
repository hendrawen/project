...
{   
    ...
    {   
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/karyawan/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/karyawan/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/karyawan/index.html';
            $config['first_url'] = base_url() . 'admin/karyawan/index.html';
        }
        ...
        $data['content']		='karyawan/karyawan_list';
    ...
    {   
		...
		'wp_jabatan_id' => $row->wp_jabatan_id,
            ...
            $data['content']		='karyawan/karyawan_read';
            $this->load->view('dashboard', $data);
        } else {
    ...
    {   
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('admin/karyawan/create_action'),
        ...
        $data['content']		='karyawan/karyawan_form';
        $this->load->view('dashboard', $data);
    }
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/karyawan/update_action'),
		...
		'wp_jabatan_id' => set_value('wp_jabatan_id', $row->wp_jabatan_id),
            ...
            $data['content']		='karyawan/karyawan_form_edit';
            $this->load->view('dashboard', $data);
        } else {
            $this->session->set_flashdata('msg', 'Data Tidak Ada');
            redirect(site_url('admin/karyawan'));
