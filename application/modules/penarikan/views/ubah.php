    ...
    <div class="x_content">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group text-right">
                <button id="button_aset" class="btn btn-success">
        ...
        <form action="#" id="form-tarik-aset" method="post">
            ...
            <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group">
                ...
                <select name="jenis" id="jenis" class="form-control">
                    <option value="krat" selected="selected">Krat</option>
                    <option value="uang">Uang</option>
                </select>
            </div>
            <div
                id="form-input-uang"
                class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group">
            ...
            <div class="form-group text-right">
                <a
                    href="<?php echo base_url('pembayaran'); ?>"
                    type="button"
                    class="btn btn-default">
                    <i class="fa fa-arrow-left"></i>
                    Kembali</a>
                <button type="button" id="btn-bayar-aset" class="btn btn-success">
