...
class Muat_model extends CI_Model
{
    ...
    var $column_order = array('wp_debt_muat.tanggal','wp_gudang.nama_gudang','wp_barang.nama_barang'); //set column field database for datatable orderable
    var $column_search = array('tanggal', 'nama_gudang','nama_barang', 'b.nama'); //set column field database for datatable searchable
