...
class Muat extends CI_Controller
{
    ...
    {
        $list = $this->muat_barang->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->muat_barang->count_all(),
                        "recordsFiltered" => $this->muat_barang->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $row = $this->muat_barang->get_by_id($id);
    ...
    {
        $row = $this->muat_barang->delete($id);
