<div class="x_panel">
  ...
  <div class="x_content">
    <div class="row" style="margin-bottom: 10px">
        <div class="col-md-4">
            <?php echo anchor(site_url('delivery/muat/create'),'<i class="fa fa-plus"> Create</i>' , 'class="btn btn-primary"'); ?>
        </div>
            ...
            foreach ($muat_data as $muat)
            {
                ...
                <tr>
                  ...
                  <td style="text-align:center" width="200px">
                    <?php
                    echo anchor(site_url('delivery/muat/update/'.$muat->id), '<button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"> Update</i></button>');
                    echo '&nbsp;';
                    echo anchor(site_url('delivery/muat/delete/'.$muat->id),'<button type="button" class="btn btn-danger btn-xs"><i class="fa fa-times"> Hapus</i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                    ?>
                  </td>
                </tr>
                <?php
