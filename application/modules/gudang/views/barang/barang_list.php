        <div class="x_panel">
              <div class="x_title">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <a href="<?php echo base_url('gudang/barang_create'); ?>" type="button" class="btn btn-primary" > <i class="fa fa-plus"></i> Tambah</a>
                    </div>
                  </div>
                              ...
                              <tbody>
                               ...
                               <tr>
                                   ...
                                   <td style="text-align:center">
                                      <a href="<?=base_url()?>gudang/barang_update/<?=$key->id ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                                      ...
                                      <a class="btn btn-default btn-sm" onclick="return swal({
                                                              ...
                                                              confirmButtonColor: '#d9534f',
                                                                    ...
                                                                    window.location.href ='<?=base_url()?>gudang/barang_delete/<?=$key->id ?>';
