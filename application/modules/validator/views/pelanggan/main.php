<a
    href="<?php echo base_url('validator/kebutuhan'); ?>"
    type="button"
        ...
        <form id="form-filter" class="form-horizontal">
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <select class="form-control" id="filter-kota">
                    <option value="" selected="selected">--Semua Kota--</option>
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <select class="form-control" id="filter-kelurahan">
                    <option value="" selected="selected">--Semua Kelurahan--</option>
                </select>
            </div>
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <select
                    ...
                    name="created_at"
                    id="created_at">
                    <option value="" readonly="readonly">Bulan</option>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                <div class="text-right">
                    <button type="button" id="btn-filter" class="btn btn-success">
