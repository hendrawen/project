...
class Validator extends CI_Controller {
    ...
    public function __construct()
  {
    ...
    $this->load->model('Validator_model', 'effectif');
  }
  ...
  { 
    ...
    $data['judul_list']		='Status Pelanggan';
  ...
  public function ajax_list()
    ...
    {   
        $data = array(
              'button' => 'Tambah',
              'action' => site_url('validator/aksi_tambah'),
              'id' => set_value('id'),
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('validator/update_action'),
