...
class Kebutuhan extends CI_Controller{
  ...
  public function __construct()
  {
    ...
    $this->load->model('validator/Model_kebutuhan','kebutuhan');
  }
  ...
  { 
    ...
    $data['sub_judul']		='Data Kebutuhan Pelanggan';
    $data['content']			= 'kebutuhan/kebutuhan';
  ...
  public function ajax_list()
    ...
    {  
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('validator/kebutuhan/create_action'),
      	    'id' => set_value('id'),
    ...
    {   
      ...
      $data['sub_judul']		='';
      $data['content']			= 'kebutuhan/presentasi';
      $data['date1'] = '';
      $data['date2'] = '';
      $data['date3'] = '';
    ...
    {   
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('validator/kebutuhan'));
        }
    }
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('validator/kebutuhan/update_action'),
