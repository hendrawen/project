...
class Pelanggan extends CI_Controller{
  ...
  {  
      ...
      foreach ($list as $pelanggans) {
          ...
          $row[] = '
          <a href="'.base_url('validator/pelanggan/update/'.$pelanggans->id).'" type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
                   ';
    ...
    {   
        ...
        if ($row) {
            $data = array(
                ...
                'button' => 'Update',
                'action' => site_url('validator/pelanggan/update_action'),
            ...
            redirect(site_url('validator/pelanggan'));
        }
    }
