...
<div class="x_panel">
  <div class="x_title">
    <h2>Laporan Transaksi <small>Marketing Per Bulanan</small></h2>
  ...
  <div class="x_content">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <button type="button" class="btn btn-success" id="btn-marketing-bulanan"><i class="fa fa-search"></i> Search</button>
        <img id="loading" src="<?=base_url();?>assets/ajax-loader.gif" alt="" style="text-align:center; display:none">
        <button type="button" id="marketing_excel_bulanan" class="btn btn-primary"><i class="fa fa-download"></i> Excel</button>
