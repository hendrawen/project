<div class="x_panel">
    <div class="x_title">
        <h2>Laporan Transaksi
            <small>Marketing Per Bulanan</small>
        </h2>
    ...
    <div class="x_content">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="input-group">
                    <span class="input-group-addon">Nama Marketing
                        <img
                            id="loading-combo"
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <button type="button" class="btn btn-success" id="btn-marketing-bulanan">
                ...
                <button type="button" id="marketing_excel_bulanan" class="btn btn-primary">
                    <i class="fa fa-download"></i>
                    Excel</button>
                <button type="button" class="btn btn-warning" id="btn-refresh-marketing">
