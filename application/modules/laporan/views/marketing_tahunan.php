  ...
  <div class="x_content">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-right">
        <button type="button" class="btn btn-success" id="btn-marketing-tahunan"><i class="fa fa-search"></i> Search</button>
        <img id="loading" src="<?=base_url();?>assets/ajax-loader.gif" alt="" style="text-align:center; display:none">
        <button type="button" id="excel_marketing_tahunan" class="btn btn-primary"><i class="fa fa-download"></i> Excel</button>
