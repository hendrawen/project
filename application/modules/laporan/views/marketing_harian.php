...
<div class="x_panel">
  <div class="x_title">
    <h2>Laporan Transaksi <small> Marketing Per tahun</small></h2>
  ...
  <div class="x_content">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
        <div class="input-group">
          <span class="input-group-addon">Marketing <img id="loading-combo" src="<?=base_url();?>assets/ajax-loader.gif" alt="" style="text-align:center; display:none"></span>
      ...
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-right">
        <button type="button" class="btn btn-success" id="btn-laporan-marketing-harian"><i class="fa fa-search"></i> Search</button>
        ...
        <button type="button" class="btn btn-warning" id="btn-refresh-marketing"> <i class="fa fa-refresh"> Reload</i> <img id="loading" src="<?=base_url();?>assets/ajax-loader.gif" alt="" style="text-align:center; display:none"></button>
      </div>
    </div>
