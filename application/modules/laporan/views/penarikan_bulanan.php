    ...
    <div class="x_content">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 text-right">
                <button type="button" class="btn btn-success" id="btn-search_bulan_aset">
                ...
                <button type="button" id="penarikan_excel_bulanan" class="btn btn-primary">
        ...
        <div class="table-responsive">
            <table
                ...
                <tbody id="tbody-penarikan"></tbody>
            </table>
        </div>
    </div>
</div>