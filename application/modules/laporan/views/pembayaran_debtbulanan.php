    ...
    <div class="x_content">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 text-right">
                <button type="button" class="btn btn-success" id="btn-debtbulan">
                ...
                <button type="button" id="excel_debtbulan" class="btn btn-primary">
            ...
            <table
                ...
                <thead>
                    <tr>
                        ...
                        <th>Jumlah Bayar</th>
                        <th>Sisa Hutang</th>
                        <th class"wider"="class" wider""="wider""">Status</th>
                    </tr>
                </thead>
