...
<footer>
    ...
    <?php
	    if ($this->uri->segment(1) == 'customerservice') {?>
    <script src="<?php echo base_url()?>assets/template/production/js/cs/effectifcall.js"></script>
    <?php
	  } ?>
    ...
    <?php if ($this->uri->segment(2) == 'sumberdata'): ?>
      <script src="<?php echo base_url()?>assets/template/production/js/cs/sumberdata.js" charset="utf-8"></script>
    <?php endif; ?>
    <?php if ($this->uri->segment(2) == 'effectivecall'): ?>
      <script src="<?php echo base_url()?>assets/template/production/js/cs/kpieffectifecall.js" charset="utf-8"></script>
    <?php endif; ?>
