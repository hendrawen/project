...
<div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form action="#" method="post">
            <!-- <form action="<?php echo base_url(). 'dep/update_action'; ?>" method="post"> -->
            ...
            <!-- <div class="col-md-4 col-sm-12 col-xs-12 form-group">
              <label for="bayar">ID Transaki *</label>
              <input type="text" id="title3" class="form-control" placeholder="ID Pelanggan" name="title3">
            </div> -->
              <input type="hidden" name="jumlah" id="jumlah" class="form-control" onloadstart="FormatCurrency(this)" placeholder="Jumlah Hutang" readonly>
              <input type="hidden" id="hutang" class="form-control" onloadstart="FormatCurrency(this)" placeholder="Total Hutang" name="hutang" readonly>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
