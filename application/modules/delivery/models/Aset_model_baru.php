...
class Aset_model extends CI_Model
{
    ...
    function get_track($cari){
        $this->db->select('wp_pelanggan.id, wp_pelanggan.id_pelanggan, wp_pelanggan.nama_pelanggan, wp_asis_debt.turun_krat, wp_asis_debt.bayar_krat, wp_asis_debt.bayar_uang, wp_asis_debt.piutang, (wp_asis_debt.turun_krat - wp_asis_debt.piutang) as sisa, wp_asis_debt.tanggal');
        $this->db->from('wp_asis_debt');
    ...
    function get_min_track($cari){
        ...
        $this->db->select('wp_transaksi.id_transaksi, (wp_asis_debt.turun_krat - wp_asis_debt.piutang) as sisa, wp_pelanggan.id_pelanggan, wp_pelanggan.id');
        $this->db->join('wp_transaksi', 'wp_asis_debt.id_transaksi = wp_transaksi.id', 'left');
    ...
    function insert_penarikan_aset($data)
    {
        // code...
        $this->db->insert('wp_penarikan', $data);
    }
