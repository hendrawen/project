...
{   
    ...
    {   
        ...
        $data['aktif']			='stok_opname';
        $data['title']			='Brajamarketindo';
        $data['judul']			='Dashboard';
        $data['sub_judul']	='Stok Opname';
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin_gudang/stok/update_action'),
  ...
  xlsWriteLabel($tablehead, $kolomhead++, "Wp Gudang Id");
    ...
    {   
        ...
        $this->load->view('admin_gudang/stok/stok_doc',$data);
    }
