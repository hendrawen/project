          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <div class="row">
                  <div class="col-md-6">
                      <!-- <a></a>
                      <?php echo anchor(site_url('admin_gudang/stok/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                      <?php echo anchor(site_url('admin_gudang/stok/word'), 'Word', 'class="btn btn-primary"'); ?> -->
                </div>
              </div>
            </div>
