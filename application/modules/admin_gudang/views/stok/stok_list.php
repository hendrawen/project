                      ...
                      <tbody>
                       ...
                       <tr>
                           ...
                           <td style="text-align:center">
                              <a href="<?=base_url()?>admin_gudang/stok/update/<?=$key->id ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                              <a class="btn btn-default btn-sm" onclick="return swal({
                                                      ...
                                                      confirmButtonColor: '#d9534f',
                                                            ...
                                                            window.location.href ='<?=base_url()?>admin_gudang/stok/delete/<?=$key->id ?>';
