            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a <?php echo ($aktif == 'pembayaran_aset')?'class="active"':"";?> href="<?php echo site_url('admin_gudang/pembayaran_aset/penarikan')?>"><i class="fa fa-money"></i> Pembayaran Aset</a></li>
                  <li><a <?php echo ($aktif == 'stok')?'class="active"':"";?> href="<?php echo site_url('admin_gudang/stok')?>"><i class="fa fa-sticky-note"></i> Stok Awal</a></li>
                  <li><a <?php echo ($aktif == 'stok_opname')?'class="active"':"";?> href="<?php echo site_url('admin_gudang/stok_opname')?>"><i class="fa fa-cube"></i> Stok Opname</a></li>
