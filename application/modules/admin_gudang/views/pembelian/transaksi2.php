      ...
      <div class="x_title">
          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <a href="<?php echo site_url('admin_gudang/pembelian/barang'); ?>" type="button" class="btn btn-primary" > <i class="fa fa-plus"></i> Tambah</a>
            </div>
          </div>
            <div class="col-md-6 text-right">
              ...
              <div class="row">
                  <div class="col-md-6">
                      <a></a>
                      <!-- <?php echo anchor(site_url('admin_gudang/pembelian/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                      <?php echo anchor(site_url('admin_gudang/pembelian/word'), 'Word', 'class="btn btn-primary"'); ?>  -->
                </div>
              </div>
            </div>
