...
<form class="" action="<?php echo site_url('admin_gudang/pembelian/checkout');?>" method="post">
  <?php $i = 1; ?>
              ...
              <section class="content invoice">
                ...
                <div class="row no-print">
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <a href="<?php echo site_url('admin_gudang/pembelian') ?>" class="btn btn-danger pull-right">Kembali</a>
                  </div>
                </div>
              </section>
            </div>
