    ...
    <div class="row">
      <form action="" id="form-kpi-marketing">
        ...
        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-6 text-right">
            <button type="button" id="btn-filter-kpi-marketing" class="btn btn-success"><i class="fa fa-search"></i> Filter</button>
            <!-- <button type="button" id="excel-kpi-marketing" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Excel</button> -->
            <button type="button" id="btn-reset-kpi-marketing" class="btn btn-info"><i class="fa fa-refresh"></i> Reload</button>
        </div>
