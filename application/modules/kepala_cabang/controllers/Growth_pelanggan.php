...
class Growth_pelanggan extends CI_Controller{
  ...
  {
    parent::__construct();
    $this->load->model('statspel/Model_laporan', 'mLap');
    $this->load->model('statspel/Model_dep', 'dep');
