...
class Area_model extends CI_Model {
    ...
    private function _get_datatables_query()
    {
        ...
        wp_transaksi.qty, wp_transaksi.tgl_transaksi, wp_transaksi.updated_at,
        wp_transaksi.username, wp_barang.nama_barang, wp_pelanggan.nama_pelanggan,
        wp_status.nama_status, wp_pelanggan.id_pelanggan, wp_pelanggan.kota, b.nama as nama_debt,
        wp_pelanggan.kecamatan, wp_pelanggan.kelurahan, , wp_pelanggan.no_telp,
        ...
        if ($this->input->post('berdasarkan')) {
            $this->db->where('wp_pelanggan.'.$this->input->post('berdasarkan'), $this->input->post('area'));
        }

        if ($this->input->post('berdasarkan2')) {
            $this->db->where('wp_pelanggan.'.$this->input->post('berdasarkan2'), $this->input->post('area2'));
        }

        if ($this->input->post('berdasarkan3')) {
            $this->db->where('wp_pelanggan.'.$this->input->post('berdasarkan3'), $this->input->post('area3'));
        }
