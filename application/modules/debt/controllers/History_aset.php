...
class History_aset extends CI_Controller {
    ...
    function harian()
    {
        ...
        $data = array(
            ...
            'judul'			=>'Dashboard',
            'sub_judul'	    =>'Aset',
            'content'		=>'history_aset/penarikan_harian',
            'month'         => $this->month,
        );
    ...
    function bulanan()
    {
        ...
        $data = array(
            ...
            'judul'			=>'Dashboard',
            'sub_judul'	    =>'Aset',
            'content'		=>'history_aset/penarikan_bulanan',
            'month'         => $this->month,
        );
        $this->load->view('dashboard', $data);
    }
    ...
    function tahunan()
    {
        ...
        $data = array(
            ...
            'judul'			=>'Dashboard',
            'sub_judul'	    =>'Aset',
            'content'		=>'history_aset/penarikan_tahunan',
            'month'         => $this->month,
        );
        $this->load->view('dashboard', $data);
    }
