...
class History_trx extends CI_Controller{
  ...
  {   
      $data = array(
          ...
          'content'		=>'history_transaksi/harian',
  ...
  {   
      $data = array(
          ...
          'judul'			=>'Dashboard',
          'sub_judul'	=>'Debt & Delivery',
          'content'		=>'history_transaksi/bulanan',
          'month'     => $this->month,
  ...
  {   
      $data = array(
          ...
          'judul'			=>'Dashboard',
          'sub_judul'	=>'Debt & Delivery',
          'content'		=>'history_transaksi/tahunan',
  ...
  { 
    $this->load->model('barang/Barang_model');
      $data = array(
          ...
          'judul'			=>'Dashboard',
          'sub_judul'	=>'Debt & Delivery',
          'content'		=>'history_transaksi/per_produk',
  ...
  {   
      $data = array(
          ...
          'judul'			=>'Dashboard',
          'sub_judul'	=>'Debt & Delivery',
          'content'		=>'history_transaksi/area',
      );
      $this->load->view('dashboard', $data);
  }
  ...
  {   
      $data = array(
          ...
          'judul'			=>'Dashboard',
          'sub_judul'	=>'Debt & Delivery',
          'content'		=>'history_transaksi/marketing',
      );
      $this->load->view('dashboard', $data);
  }
  ...
  */
  ...
  { 
    ...
    $data = array(
        ...
        'judul'			=>'Dashboard',
        'sub_judul'	=>'Debt & Delivery',
        'content'		=>'history_transaksi/pelanggan',
        'month'     => $this->month,
        // 'record'    => $record,
