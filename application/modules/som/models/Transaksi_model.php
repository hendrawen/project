...
class Transaksi_model extends CI_Model
{
    ...
    var $column_order = array('id_transaksi','tgl_transaksi', 'id_pelanggan', 'nama_pelanggan', 'kota', 'kelurahan', 'kecamatan', null); //set column field database for datatable orderable
    var $column_search = array('id_transaksi','id_pelanggan','nama_pelanggan','jatuh_tempo','tgl_transaksi', 'kota'); //set column field database for datatable searchable
