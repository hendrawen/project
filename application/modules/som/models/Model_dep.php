...
class Model_dep extends CI_Model{
  ...
  function laporan_pelanggan($from, $to, $year)
  {
    ...
    // $this->db->distinct();
    // $this->db->select('DISTINCT(wp_pelanggan.id_pelanggan), wp_transaksi.id_transaksi, harga, qty, subtotal, tgl_transaksi,wp_pelanggan.no_telp, wp_pelanggan.kelurahan,wp_pelanggan.kecamatan,
