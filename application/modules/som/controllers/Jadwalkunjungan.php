<?php
    ...
    class Jadwalkunjungan extends CI_Controller {
        ...
        public function create()
        {
            $data = array(
              'button'     => 'Tambah',
              'action'     => site_url('som/jadwalkunjungan/create_action'),
        ...
        public function create_action()
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(site_url('som/jadwalkunjungan'));
            }
        }
        ...
        public function update($id)
        {
            ...
            if ($row) {
              $data = array(
                'button'     => 'Update',
                'action'     => site_url('som/jadwalkunjungan/update_action'),
