...
class Exceldep extends CI_Controller{
  ...
  public function __construct()
  {
    ...
    $this->load->model('Model_dep', 'mLap');

  }

  function harian($day, $nama)
  {
  ...
  function bulanan($from, $to, $year, $nama)
  {
      $this->load->helper('exportexcel');
      ...
      xlsWriteLabel($tablehead, $kolomhead++, "Debt");
      xlsWriteLabel($tablehead, $kolomhead++, "Jumlah");
      $record = $this->mLap->laporan_bulanan($from, $to, $year, $nama);
      $total = 0;
      foreach ($record as $data) {
          $kolombody = 0;
          xlsWriteNumber($tablebody, $kolombody++, $nourut);
  ...
  function tahunan($year, $nama)
  {
      ...
      xlsWriteLabel($tablehead, $kolomhead++, "Debt");
      xlsWriteLabel($tablehead, $kolomhead++, "Jumlah");
      $record = $this->mLap->laporan_tahunan($year, $nama);
      $total = 0;
      foreach ($record as $data) {
          $kolombody = 0;
          xlsWriteNumber($tablebody, $kolombody++, $nourut);
