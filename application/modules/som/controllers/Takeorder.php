...
class Takeorder extends CI_Controller {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $lists) {
            ...
            $row[] = '
            <a href="'.base_url('som/takeorder/update/'.$lists->id).'" type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
    ...
    {   
        $data = array(
              'button' => 'Tambah',
              'action' => site_url('som/takeorder/aksi_tambah'),
              'id' => set_value('id'),
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('som/takeorder/update_action'),
