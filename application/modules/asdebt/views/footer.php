<!-- footer content -->
    ...
    <?php if ($uri1 == 'asdebt' && $uri2 == 'pelanggan'): ?>
    <script src="<?= base_url('assets/template/production/js/asdebt/pelanggan.js')?>"></script>
    <?php endif; ?>

    <?php if ($uri1 == 'asdebt' && $uri2 == 'pembayaran'): ?>
    <script src="<?php echo base_url('assets/template/production/js/asdebt/pembayaran.js')?>" charset="utf-8"></script>
    <?php endif; ?>

    <?php if ($uri1 == 'asdebt' && $uri2 == 'kpi'): ?>
    <script src="<?php echo base_url('assets/template/production/js/asdebt/kpi-asdebt.js')?>" charset="utf-8"></script>
    <?php endif; ?>

    <?php if ($uri1 == 'asdebt' && $uri2 == 'history_aset'): ?>
    <script src="<?php echo base_url('assets/template/production/js/asdebt/laporan_penarikan.js')?>" charset="utf-8"></script>
    <?php endif; ?>

    <?php if ($uri1 == 'asdebt' && $uri2 == 'history_piutang'): ?>
    <script src="<?php echo base_url('assets/template/production/js/asdebt/laporan_pembayaran.js')?>" charset="utf-8"></script>
    <?php endif; ?>

    <?php if ($uri1 == 'asdebt' && $uri2 == 'history_trx'): ?>
    <script src="<?php echo base_url('assets/template/production/js/asdebt/laporan_penjualan.js')?>" charset="utf-8"></script>
    <?php endif; ?>
