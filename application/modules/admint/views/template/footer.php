...
<footer>
    ...
    <script src="<?php echo base_url()?>assets/template/production/js/admint/transaksi.js"></script>
    <script src="<?php echo base_url()?>assets/template/production/js/pembelian.js"></script>
    <script src="<?php echo base_url()?>assets/template/production/js/admint/transaksi_admin.js"></script>
    ...
    <script src="<?php echo base_url()?>assets/template/production/js/admint/pembayaran.js"></script>
    <script src="<?php echo base_url()?>assets/template/production/js/admint/custom.js"></script>
    ...
    <script src="<?php echo base_url()?>assets/template/production/js/admint/pelanggan.js"></script>
    <?php
	  } ?>
    <?php
	    if ($this->uri->segment(1) == 'validator') {?>
    <script src="<?php echo base_url()?>assets/template/production/js/validator/effectifcall.js"></script>
    <?php
	  } ?>
    ...
    <?php if ($this->uri->segment(2) == 'sumberdata'): ?>
      <script src="<?php echo base_url()?>assets/template/production/js/validator/sumberdata.js" charset="utf-8"></script>
    <?php endif; ?>
    <?php if ($this->uri->segment(2) == 'effectivecall'): ?>
      <script src="<?php echo base_url()?>assets/template/production/js/validator/kpieffectifecall.js" charset="utf-8"></script>
    <?php endif; ?>
    ...
    <?php if ($this->uri->segment(2) == 'kas'): ?>
      <script src="<?php echo base_url()?>assets/template/production/js/admin/kas.js" charset="utf-8"></script>
    <?php endif; ?>
