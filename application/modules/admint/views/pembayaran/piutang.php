...
<div class="x_panel">
        ...
        <div class="x_content">
          ...
          <!-- start form for validation -->
          <form action="<?php echo base_url(). 'admint/pembayaran/track_pembayaran'; ?>" method="post">
            ...
            <a href="<?php echo base_url('admint/pembayaran'); ?>" type="button" class="btn btn-default" > <i class="fa fa-arrow-left"></i> Kembali</a>
