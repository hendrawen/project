...
class Pelanggan extends CI_Controller{
  ...
  {   
      ...
      foreach ($list as $pelanggans) {
          ...
          $row[] = '
          <a href="'.base_url('admint/pelanggan/update/'.$pelanggans->id).'" type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
    ...
    {   
        $data = array(
            'list_kategori' => $this->pelanggan->get_kategori(),
              'button' => 'Tambah',
              'action' => site_url('admint/pelanggan/aksi_tambah'),
              'id' => set_value('id'),
    ...
    public function aksi_tambah()
    {
      ...
      if ($this->form_validation->run() == FALSE) {
          ...
          redirect(site_url('admint/pelanggan'));
      }
    }
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'list_kategori' => $this->pelanggan->get_kategori(),
                'button' => 'Update',
                'action' => site_url('admint/pelanggan/update_action'),
