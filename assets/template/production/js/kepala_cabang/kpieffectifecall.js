$(document).ready(function () {
  get_all_eff();
    ...
    function get_all_eff() {
      $("#loading").show();
      $.ajax({
        url: base_url+'kepala_cabang/effectivecall/load_all/',
        type: 'POST',
        dataType: 'html',
...
$("#berdasarkan-eff").change(function() {
  ...
  $.ajax({
  url: base_url+'kepala_cabang/effectivecall/isi_karyawan/'+berdasarkan,
  type: 'POST',
  dataType: 'html',
  success : function (data) {
      $("#loading-combo").hide();
...
$("#btn-filter-eff").click(function() {
  ...
  $.ajax({
    url: base_url+'kepala_cabang/effectivecall/load_filter/',
    type: 'POST',
    dataType: 'html',
