...
$(document).ready(function () {
    table = $('#tbl_pembayaran').dataTable({
        ...
        "ajax": {
            "url": (base_url + "kepala_cabang/pembayaran/ajax_list"),
            "type": "POST",
            "data": function (data) {}
        },
...
function hapus(faktur) {
    ...
    $.ajax({
        type: "post",
        url: base_url + "kepala_cabang/pembayaran/get_faktur",
        data: {
            faktur: faktur
        },
        dataType: "json",
...
function edit_action() {
    ...
    $.ajax({
        type: "post",
        url: base_url + "kepala_cabang/pembayaran/cek_password_edit",
        data: {
            password: password,
            faktur: faktur
        },
        ...
        success: function (response) {
            pesan_cek();
            if (response) {
                location.href = base_url+'kepala_cabang/pembayaran/update/'+faktur;
            } else {
...
function hapus_action() {
    ...
    $.ajax({
        type: "post",
        url: base_url + "kepala_cabang/pembayaran/cek_password",
        data: {
            password: password,
            faktur: faktur
        },
