...
$(document).ready(function() {
    ...
    table = $('#table-penjualan-debt-admin2').DataTable({
        ...
        "ajax": {
            "url": base_url+"kepala_cabang/penjualandebt/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
function excel_tanggal() {
    ...
    window.location = base_url + 'kepala_cabang/penjualandebt/excel_tanggal/'+tgl+'/'+debt+'/'+status;
}
...
function excel_bulan() {
    ...
    window.location = base_url + 'kepala_cabang/penjualandebt/excel_bulan/'+dari+'/'+ke+'/'+tahun+'/'+debt+'/'+status;
}
...
function excel_tahun() {
    ...
    window.location = base_url + 'kepala_cabang/penjualandebt/excel_tahun/'+tahun+'/'+debt+'/'+status;
}
