...
$(document).ready(function () {
	...
	table = $('#table-laporan-marketing-admin').DataTable({
		...
		"ajax": {
			"url": base_url + "kepala_cabang/marketing/ajax_list",
			"type": "POST",
			"data": function (data) {
...
$("#excel_marketing_harian").click(function () {
	...
	window.location = base_url + 'kepala_cabang/excel/marketing_harian/' + tgl + '/' + n;
});
...
$("#berdasarkan-marketing1").change(function () {
	...
	$.ajax({
		url: base_url + 'kepala_cabang/marketing/isi_marketing/' + berdasarkan,
		type: 'POST',
		dataType: 'html',
...
$("#marketing_excel_bulanan_admin").click(function () {
	...
	window.location = base_url + 'kepala_cabang/excel/marketing_bulanan/' + b1 + '/' + b2 + '/' + t + '/' + n;
});

$("#excel_marketing_tahunan").click(function () {
	t = $("#filter-tahun2").val();
	n = $("#nama-marketing3").val();
	window.location = base_url + 'kepala_cabang/excel/marketing_tahunan/' + t + '/' + n;
});
