$(document).ready(function () {
    get_all_sumber();
      ...
      function get_all_sumber() {
        $("#loading").show();
        $.ajax({
          url: base_url+'kepala_cabang/sudavalidator/load_all/',
          type: 'POST',
          dataType: 'html',
  ...
  $("#berdasarkan-sumber").change(function() {
    ...
    $.ajax({
    url: base_url+'kepala_cabang/validator/isi_karyawan_validator/'+berdasarkan,
    type: 'POST',
    dataType: 'html',
    success : function (data) {
        $("#loading-combo").hide();
  ...
  $("#btn-filter-sumber").click(function() {
    ...
    $.ajax({
      url: base_url+'kepala_cabang/sudavalidator/load_filter/',
      type: 'POST',
      dataType: 'html',
