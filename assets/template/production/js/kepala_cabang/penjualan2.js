...
$(document).ready(function() {
    ...
    //datatables
    table = $('#table-penjualan3').DataTable({
        ...
        "ajax": {
            "url": base_url+"kepala_cabang/penjualan2/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
{
    $('#table-penjualan3').DataTable().ajax.reload();//reload datatable ajax
}
...
function excel_tanggal() {
    ...
    window.location = base_url + 'kepala_cabang/penjualan2/excel_tanggal/'+tgl+'/'+status;
}
...
function excel_bulan() {
    ...
    window.location = base_url + 'kepala_cabang/penjualan2/excel_bulan/'+dari+'/'+ke+'/'+tahun+'/'+status;
}
...
function excel_tahun() {
    ...
    window.location = base_url + 'kepala_cabang/penjualan2/excel_tahun/'+tahun+'/'+status;
}
