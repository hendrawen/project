...
$(document).ready(function() {
    ...
    //datatables
    table = $('#table-pembayaran-debt').DataTable({
        ...
        "ajax": {
            "url": base_url+"kepala_cabang/pembayarandebt/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
{
    $('#table-pembayaran-debt').DataTable().ajax.reload();//reload datatable ajax
}
...
function excel_tanggal() {
    ...
    window.location = base_url + 'kepala_cabang/pembayarandebt/excel_tanggal/'+tgl+'/'+debt;
}
...
function excel_bulan() {
    ...
    window.location = base_url + 'kepala_cabang/pembayarandebt/excel_bulan/'+dari+'/'+ke+'/'+tahun+'/'+debt+'/'+status;
}
...
function excel_tahun() {
    ...
    window.location = base_url + 'kepala_cabang/pembayarandebt/excel_tahun/'+tahun+'/'+debt;
}
