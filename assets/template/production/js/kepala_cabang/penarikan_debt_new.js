...
$(document).ready(function() {
    ...
    //datatables
    table = $('#table-penarikan-debt').DataTable({
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 16 ).footer() ).html(
                $("#total").html('Total Penarikan : Rp. '+formatCurrency(total))
            );
        },
        ...
        "ajax": {
            "url": base_url+"kepala_cabang/penarikandebt/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
{
    $('#table-penarikan-debt').DataTable().ajax.reload();//reload datatable ajax
}
...
function excel_tanggal() {
    ...
    window.location = base_url + 'kepala_cabang/penarikandebt/excel_tanggal/'+tgl+'/'+debt;
}
...
function excel_bulan() {
    ...
    window.location = base_url + 'kepala_cabang/penarikandebt/excel_bulan/'+dari+'/'+ke+'/'+tahun+'/'+debt;
}
...
function excel_tahun() {
    ...
    window.location = base_url + 'kepala_cabang/penarikandebt/excel_tahun/'+tahun+'/'+debt;
}
