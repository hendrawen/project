     ...
     $(document).ready(function () {
        ...
        $('#kelurahan').select2();
          table = $('#table').dataTable({
           ...
           "ajax": {
               "url": (base_url+"admint/pelanggan/ajax_list"),
               "type": "POST",
               "data": function ( data ) {
      ...
      function delete_pelanggan(id)
      {
          if(confirm('Are you sure delete this data?'))
          {
              ...
              $.ajax({
                  url : (base_url+"admint/pelanggan/ajax_delete/"+id),
                  type: "POST",
                  dataType: "JSON",
      ...
      $("#kota").change(function(event) {
        ...
        $.ajax({
          url: base_url+'admint/pelanggan/get_kecamatan/'+id_kota,
          dataType: 'html',
          success : function (data) {
      ...
      $("#kecamatan").change(function(event) {
        ...
        $.ajax({
          url: base_url+'admint/pelanggan/get_kelurahan/'+id_kecamatan,
          dataType: 'html',
          success : function (data) {
