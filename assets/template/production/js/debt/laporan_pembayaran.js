$(document).ready(function() {
  load_Pembayaran();
    ...
    $("#debtharian").click(function() {
      ...
      $.ajax({
        url: base_url+'debt/history_piutang/load_debt_harian/',
        type: 'POST',
        dataType: 'html',
    ...
    $("#btn-debtbulan").click(function() {
      ...
      $.ajax({
        url: base_url+'debt/history_piutang/load_debt_bulanan/',
        type: 'POST',
        dataType: 'html',
    ...
    $("#btn-laporan-pembayaran-harian").click(function() {
      ...
      $.ajax({
        url: base_url+'debt/history_piutang/load_pembayaran_harian/',
        type: 'POST',
        dataType: 'html',
        data: {tgl: tgl},
        success : function (data) {
    ...
    $("#btn-search_bulan").click(function() {
      ...
      $.ajax({
        url: base_url+'debt/history_piutang/load_pembayaran_bulanan/',
        type: 'POST',
        dataType: 'html',
    ...
    $("#btn-search_tahun").click(function() {
      ...
      $.ajax({
        url: base_url+'debt/history_piutang/load_pembayaran_tahunan/',
        type: 'POST',
        dataType: 'html',
        data: {tahun : tahun},
        success : function (data) {
  ...
  function load_Pembayaran() {
    $("#loading").show();
    $.ajax({
      url: base_url+'debt/history_piutang/load_pembayaran_all/',
      dataType: 'html',
      success : function (data) {
        $("#loading").hide();
        $("#tbody").html(data);
