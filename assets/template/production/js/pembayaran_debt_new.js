...
$(document).ready(function() {
    ...
    table = $('#table-pembayaran-debt').DataTable({ 
        ...
        "ajax": {
            "url": base_url+"laporan/pembayarandebt/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
function excel_tanggal() {
    ...
    window.location = base_url + 'laporan/pembayarandebt/excel_tanggal/'+tgl+'/'+debt;
}
...
function excel_bulan() {
    ...
    window.location = base_url + 'laporan/pembayarandebt/excel_bulan/'+dari+'/'+ke+'/'+tahun+'/'+debt+'/'+status;
}
...
function excel_tahun() {
    ...
    window.location = base_url + 'laporan/pembayarandebt/excel_tahun/'+tahun+'/'+debt;
}
