...
$(document).ready(function() {
    ...
    table = $('#table-kas').DataTable({
        ...
        "ajax": {
            "url": base_url + "bendahara/kas/ajax_list",
            "type": "POST",
            "data": function ( data ) {
...
function simpan()
{
    ...
    if(save_method == 'add') {
        url = base_url+"bendahara/kas/ajax_add";
    } else {
        url = base_url+"bendahara/kas/ajax_update";
    }
...
function hapus(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : base_url+"bendahara/kas/ajax_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function isi_karyawan() {
    ...
    $.ajax({
        url: base_url+"bendahara/kas/get_karyawan",
        dataType: "json",
...
function isi_kantor() {
    $('#id_kantor')
        ...
        .append('<option selected="selected" value="">-- Select One --</option>');
    $.ajax({
        url: base_url+"bendahara/kas/get_kantor",
        dataType: "json",
        success: function (response) {
            $.each(response, function(key, value) {
                $('#id_kantor')
...
function isi_kategori() {
    $('#id_kategori')
        ...
        .append('<option selected="selected" value="">-- Select One --</option>');
    $.ajax({
        url: base_url+"bendahara/kas/get_kategori",
        dataType: "json",
        success: function (response) {
            $.each(response, function(key, value) {
                $('#id_kategori')
...
function saldo() {
    $.ajax({
        url: base_url+"bendahara/kas/get_saldo",
        dataType: "json",
        success: function (response) {
            $(".saldo").html(response);
        }
...
$("#btn-kas-harian").click(function() {
    ...
    $.ajax({
      url: base_url+'bendahara/kas/load_kas_harian/',
      type: 'POST',
      dataType: 'html',
  ...
  $("#btn-kas-bulanan").click(function() {
    ...
    $.ajax({
      url: base_url+'bendahara/kas/load_kas_bulanan/',
      type: 'POST',
      dataType: 'html',
  ...
  $("#btn-kas-tahunan").click(function() {
    ...
    $.ajax({
      url: base_url+'bendahara/kas/load_kas_tahunan/',
      type: 'POST',
      dataType: 'html',
