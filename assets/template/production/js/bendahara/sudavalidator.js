$(document).ready(function () {
    get_all_sumber();
      ...
      function get_all_sumber() {
        $("#loading").show();
        $.ajax({
          url: base_url+'bendahara/sudavalidator/load_all/',
          type: 'POST',
          dataType: 'html',
  ...
  $("#berdasarkan-sumber").change(function() {
    ...
    $.ajax({
    url: base_url+'bendahara/validator/isi_karyawan_validator/'+berdasarkan,
    type: 'POST',
    dataType: 'html',
    success : function (data) {
        $("#loading-combo").hide();
  ...
  $("#btn-filter-sumber").click(function() {
    ...
    $.ajax({
      url: base_url+'bendahara/sudavalidator/load_filter/',
      type: 'POST',
      dataType: 'html',
